    ...
    ) => 
{
    ...
    return (
        ...
        {`${path == currentPath ? 'bg-blue-800' : '' }  w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-emerald-500 transition ease-linear duration-150`}
